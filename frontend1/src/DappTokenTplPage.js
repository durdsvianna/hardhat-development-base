...
export default class DappTemplatePage extends React.Component {
  ...
  async _transferTokens(to, amount) {
    ...
    try {
      ...
      console.log("iniciou transferencia");
      // We send the transaction, and save its hash in the Dapp's state. This
      // way we can indicate that we are waiting for it to be mined.
      const tx = await this._token.transfer(to, ethers.utils.parseEther(amount));
      this.setState({ txBeingSent: tx.hash });

      // We use .wait() to wait for the transaction to be mined. This method
      // returns the transaction's receipt.
      const receipt = await tx.wait();
      console.log("terminou transferencia");
            ...
            <Content2Xl>
              <NavRow>
                ...
                <div tw="flex flex-col lg:flex-row items-center">
                  ...
                  <NavLink target="_blank" href="https://www.linkedin.com/in/daniel-vianna-431a0932/">
                    Who Am I ?
                  </NavLink>
      ...
      <AnimationRevealPage disabled>
        <Container tw="-mx-8 -mt-8 pt-8 px-8">
          <Content2Xl>
            ...
            <HeroRow>
              <Heading>{this.state.tokenData.name} ({this.state.tokenData.symbol})</Heading>
            </HeroRow>
            <HeroRow>
              <Description tw="mt-12">Template para desenvolvimento de projetos web3.</Description>              
            </HeroRow>
                          
            
            <HeroRow>
              Bem vindo <b>{this.state.selectedAddress}</b>, você possui{" "}
                  <b>
                    {ethers.utils.formatEther(this.state.balance)} {this.state.tokenData.symbol}
                  </b>
                  .
            </HeroRow>              
                <div tw="mx-64 text-center">
                  {/*
              ...
              <HeroRow>     
                <div tw="mt-4 text-center">
                  <div tw="mt-12 flex flex-col items-center">     
                    <Description tw="mt-12">Template para desenvolvimento de projetos web3 disponível em: </Description>               
                    <div tw="mt-8">
                      <GitHubButton
                        href="https://github.com/durdsvianna"
                        data-size="large"
                        data-show-count="true"
                        aria-label="Follow @durdsvianna on GitHub"
                      >
                        Follow @durdsvianna
                      </GitHubButton>
                    </div>
